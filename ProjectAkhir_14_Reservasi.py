...
def validasi_nama_penumpang():
    while True:
        ...
        if nama_penumpang:  # Memeriksa apakah nama tidak kosong
...
def validasi_nomor_identitas():
    while True:
        ...
        if nomor_identitas.isdigit() and len(nomor_identitas) == 10:  # Misalnya, kita anggap nomor identitas harus 10 digit
